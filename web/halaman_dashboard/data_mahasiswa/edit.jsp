        ...
        <div class="card-body">
            <h4 class="card-title mb-4">Edit data mahasiswa</h4>
                        <% try{
                                ...
                                PreparedStatement pst = con.prepareStatement("select * from datamahasiswa where id=?");
