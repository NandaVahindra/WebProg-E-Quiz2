        ...
        <div class="card-body">
            <h4 class="card-title mb-4">Edit data mahasiswa</h4>
                        <% try{
                                ...
                                PreparedStatement pst = con.prepareStatement("select * from data_kelas where id=?");
                ...
                <form class="forms-sample" method="post" action="../../editkelas">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="jurusan" name="tahunAjaran"
                            value="<%=rs.getString("tahunAjaran")%>" required>
                    </div>
                    <button type="submit" class="btn btn-primary me-2">Edit</button>
                    <a href="index.jsp" class="btn btn-light">Kembali</a>
                </form>
                                                     <%
                                }
                                } catch(Exception e){
